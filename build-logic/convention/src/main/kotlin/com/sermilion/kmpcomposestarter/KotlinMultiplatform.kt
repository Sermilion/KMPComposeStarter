 ...
 *
 * `starter.dataDir` is set alongside it because any module whose tests reach the real graph — not
 * only `core:data` — resolves the desktop database and preferences paths through it, and a test
 * that writes into the developer's home directory is a test that leaks between runs.
 */
internal fun Project.configureTests() {
  ...
  tasks.withType<Test>().configureEach {
    useJUnitPlatform()
    systemProperty("starter.dataDir", testDataDir)
  }
