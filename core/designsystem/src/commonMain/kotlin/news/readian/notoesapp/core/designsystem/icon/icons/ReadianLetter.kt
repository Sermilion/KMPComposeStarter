...
val ReadianIcons.ReadianLetter: ImageVector
  get() {
    if (icReadianLetter != null) {
      return icReadianLetter!!
    }
    icReadianLetter = Builder(
      name = "IcReadianLetter",
      ...
      path(
        fill = SolidColor(Color(0xFF2C73F3)),
        stroke = null,
...
private var icReadianLetter: ImageVector? = null
